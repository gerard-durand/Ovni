...
REM Ne marche pas à la construction des dlls, car cherche certaines libs en 32 bits qu'il ne trouve pas (comme libkernel32.a) et plusieurs autres. A essayer avec C:\MinGW32\bin 
REM où il y a bien 2 versions de libs, ou une version 32 bits only des toolchains (qui serait dans C:\msys64\mingw32\bin).
...
mingw32-make -f makefile.gcc -j 4 SHARED=1 MONOLITHIC=1 BUILD=release CFG="_32" VENDOR=%CB_ID% clean
echo %time% >> 00_test.txt
