...
Prefs_Dialog::Prefs_Dialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	CheckBox_1SeulObjet3D = new wxCheckBox(this, ID_CHECKBOX8, _T("Forcer la lecture des fichiers .obj et .dxf dans 1 seul Objet 3D"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
