...
Prefs_Dialog::Prefs_Dialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _T("Longueur des normales"), wxDefaultPosition, wxSize(132,16), 0, _T("ID_STATICTEXT3"));
	...
	StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _T("Rayon de la source"), wxDefaultPosition, wxSize(260,15), 0, _T("ID_STATICTEXT4"));
	BoxSizer4->Add(StaticText4, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	...
	StaticText_Gouraud = new wxStaticText(this, ID_STATICTEXT5, _T("Seuil de comparaison des normales (degrés) :"), wxDefaultPosition, wxSize(260,15), 0, _T("ID_STATICTEXT5"));
	...
	StaticText8 = new wxStaticText(this, ID_STATICTEXT8, _T("0 <=> Pas de sauvegarde"), wxDefaultPosition, wxSize(255,15), 0, _T("ID_STATICTEXT8"));
	BoxSizer5->Add(StaticText8, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5);
	SpinCtrl_PasSvg = new wxSpinCtrl(this, ID_SPINCTRL1, _T("0"), wxDefaultPosition, wxSize(78,23), 0, 0, 100, 0, _T("ID_SPINCTRL1"));
	SpinCtrl_PasSvg->SetValue(_T("0"));
	SpinCtrl_PasSvg->SetMaxSize(wxSize(78,0));
	BoxSizer5->Add(SpinCtrl_PasSvg, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer1->Add(RadioBox_Trackball, 1, wxALL|wxEXPAND, 5);
