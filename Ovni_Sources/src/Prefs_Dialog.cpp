...
//(*IdInit(Prefs_Dialog)
const wxWindowID Prefs_Dialog::ID_STATICTEXT1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRLDOUBLE1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT3 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRLDOUBLE2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE4 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT4 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRLDOUBLE3 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE5 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE3 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX8 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX3 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX4 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT5 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRLDOUBLE4 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT6 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRLDOUBLE5 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX6 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX5 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX11 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX12 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE6 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT7 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT8 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRL1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE7 = wxNewId();
...
const wxWindowID Prefs_Dialog::ID_CHECKBOX9 = wxNewId();
const wxWindowID Prefs_Dialog::ID_CHECKBOX10 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE11 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT9 = wxNewId();
const wxWindowID Prefs_Dialog::ID_TEXTCTRL10 = wxNewId();
const wxWindowID Prefs_Dialog::ID_BUTTON1 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE9 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICTEXT10 = wxNewId();
const wxWindowID Prefs_Dialog::ID_SPINCTRL2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_STATICLINE12 = wxNewId();
const wxWindowID Prefs_Dialog::ID_BUTTON2 = wxNewId();
const wxWindowID Prefs_Dialog::ID_BUTTON3 = wxNewId();
//*)
...
Prefs_Dialog::Prefs_Dialog(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	Create(parent, wxID_ANY, _T("Préférences de l\'application"), wxDefaultPosition, wxDefaultSize, wxSTAY_ON_TOP|wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER, _T("wxID_ANY"));
	Hide();
	BoxSizer1 = new wxBoxSizer(wxVERTICAL);
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _T("Valeurs = coefficient par rapport à la diagonale de la boîte englobante "), wxDefaultPosition, wxSize(-1,15), wxALIGN_CENTRE, _T("ID_STATICTEXT1"));
	BoxSizer1->Add(StaticText1, 0, wxALL|wxEXPAND, 1);
	...
	CheckBox_AntialiasingSoft = new wxCheckBox(this, ID_CHECKBOX1, _T("Anti-aliasing géré par OpenGL"), wxDefaultPosition, wxSize(-1,-1), 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
	...
	CheckBox_1SeulObjet3D = new wxCheckBox(this, ID_CHECKBOX8, _T("Forcer la lecture des fichiers .obj et .dxf dans 1 seul Objet 3D"), wxDefaultPosition, wxSize(-1,-1), 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
	CheckBox_1SeulObjet3D->SetValue(false);
	BoxSizer1->Add(CheckBox_1SeulObjet3D, 0, wxLEFT|wxRIGHT|wxEXPAND, 5);
	CheckBox_LectureOptimisee = new wxCheckBox(this, ID_CHECKBOX2, _T("Lecture optimisée des tableaux de points des fichiers de type .obj"), wxDefaultPosition, wxSize(-1,-1), 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
	CheckBox_LectureOptimisee->SetValue(false);
	BoxSizer1->Add(CheckBox_LectureOptimisee, 0, wxLEFT|wxRIGHT|wxEXPAND, 5);
	CheckBox_TestDecalage3DS = new wxCheckBox(this, ID_CHECKBOX3, _T("Lecture du décalage éventuel des objets dans les fichiers .3ds"), wxDefaultPosition, wxSize(-1,-1), 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
	CheckBox_TestDecalage3DS->SetValue(false);
	BoxSizer1->Add(CheckBox_TestDecalage3DS, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND, 5);
	StaticLine2 = new wxStaticLine(this, ID_STATICLINE2, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE2"));
	BoxSizer1->Add(StaticLine2, 0, wxALL|wxEXPAND, 0);
	CheckBox_Seuillage = new wxCheckBox(this, ID_CHECKBOX4, _T("Calculs et visualisation avec seuillage des normales"), wxDefaultPosition, wxSize(-1,-1), 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
	CheckBox_Seuillage->SetValue(false);
	BoxSizer1->Add(CheckBox_Seuillage, 0, wxLEFT|wxRIGHT|wxALIGN_LEFT, 5);
	...
	BoxSizer1->Add(CheckBox_RecNormales_Seuillees, 0, wxLEFT|wxRIGHT|wxEXPAND, 25);
	...
	CheckBox_NotFlat = new wxCheckBox(this, ID_CHECKBOX11, _T("Forcer toutes les facettes à être NON planes"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX11"));
	CheckBox_NotFlat->SetValue(false);
	BoxSizer1->Add(CheckBox_NotFlat, 0, wxLEFT|wxRIGHT, 5);
	...
	BoxSizer1->Add(CheckBox_TraiterDoublonsAretes, 1, wxLEFT|wxRIGHT, 5);
	...
	RadioBox_Triangulation = new wxRadioBox(this, ID_RADIOBOX1, _T("Méthode de triangulation"), wxPoint(-1,-1), wxSize(382,40), 3, __wxRadioBoxChoices_1, 1, wxRA_SPECIFY_ROWS, wxDefaultValidator, _T("ID_RADIOBOX1"));
	...
	BoxSizer1->Add(CheckBox_DisplayFps, 0, wxLEFT|wxRIGHT|wxEXPAND, 5);
	...
	BoxSizer1->Add(CheckBox_CreerBackup, 0, wxLEFT|wxRIGHT|wxEXPAND, 5);
	...
	BoxSizer1->Add(CheckBox_SupprBackup, 0, wxLEFT|wxRIGHT|wxEXPAND, 25);
	...
	BoxSizer1->Add(StaticText9, 0, wxTOP|wxLEFT|wxRIGHT|wxEXPAND, 5);
	BoxSizer2 = new wxBoxSizer(wxHORIZONTAL);
	TextCtrl_WorkDir = new wxTextCtrl(this, ID_TEXTCTRL10, _T("C:"), wxDefaultPosition, wxSize(394,21), wxTE_RIGHT, wxDefaultValidator, _T("ID_TEXTCTRL10"));
	BoxSizer2->Add(TextCtrl_WorkDir, 0, wxLEFT|wxRIGHT|wxALIGN_BOTTOM, 5);
	Button_tmp_rep = new wxButton(this, ID_BUTTON1, _T("..."), wxDefaultPosition, wxSize(40,21), 0, wxDefaultValidator, _T("ID_BUTTON1"));
	...
	Connect(ID_TEXTCTRL10, wxEVT_COMMAND_TEXT_ENTER, (wxObjectEventFunction)&Prefs_Dialog::OnTextCtrl_WorkDirText);
...
{
    MAIN->Element->wxWorkDir = TextCtrl_WorkDir->GetValue();        // SetLabel() est OK aussi
    ...
    if(!MAIN->Element->wxWorkDir.EndsWith(Last_Char)) {             // Si séparateur de path absent à la fin, l'ajouter
        ...
        TextCtrl_WorkDir->SetValue(MAIN->Element->wxWorkDir);       // et mettre à jour dans TextCtrl_WorkDir
    }
    MAIN->Element->wxWorkDir = TextCtrl_WorkDir->GetValue();        // Utile si entrée directe dans le wxTextCtrl
    MAIN->Element->ini_file_modified = true ;
}
