...
//(*IdInit(Cylindre)
const wxWindowID Cylindre::ID_STATICTEXT1 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL1 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT2 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL2 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT3 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL3 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT4 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL4 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT5 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL5 = wxNewId();
const wxWindowID Cylindre::ID_TEXTCTRL6 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT6 = wxNewId();
const wxWindowID Cylindre::ID_BUTTON1 = wxNewId();
const wxWindowID Cylindre::ID_BUTTON2 = wxNewId();
const wxWindowID Cylindre::ID_CHECKBOX1 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT7 = wxNewId();
const wxWindowID Cylindre::ID_SPINCTRL1 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT8 = wxNewId();
const wxWindowID Cylindre::ID_SPINCTRL2 = wxNewId();
const wxWindowID Cylindre::ID_STATICTEXT9 = wxNewId();
const wxWindowID Cylindre::ID_SPINCTRL3 = wxNewId();
//*)
