...
namespace AutoVersion{
	...
	static const long REVISION  = 4710;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 894;
	#define RC_FILEVERSION 5,3,0,4710
	#define RC_FILEVERSION_STRING "5, 3, 0, 4710\0"
	static const char FULLVERSION_STRING [] = "5.3.0.4710";
