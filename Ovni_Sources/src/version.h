...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 1599;
	#define RC_FILEVERSION 5,4,28,10793
	#define RC_FILEVERSION_STRING "5, 4, 28, 10793\0"
	static const char FULLVERSION_STRING [] = "5.4.28.10793";
