...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 1545;
	#define RC_FILEVERSION 5,3,7,8356
	#define RC_FILEVERSION_STRING "5, 3, 7, 8356\0"
	static const char FULLVERSION_STRING [] = "5.3.7.8356";
