...
namespace AutoVersion{
	...
	static const long REVISION  = 8815;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 1553;
	#define RC_FILEVERSION 5,3,12,8815
	#define RC_FILEVERSION_STRING "5, 3, 12, 8815\0"
	static const char FULLVERSION_STRING [] = "5.3.12.8815";
