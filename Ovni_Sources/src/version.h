...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 1569;
	#define RC_FILEVERSION 5,4,2,9385
	#define RC_FILEVERSION_STRING "5, 4, 2, 9385\0"
	static const char FULLVERSION_STRING [] = "5.4.2.9385";
