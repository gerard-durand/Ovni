...
namespace AutoVersion{
	...
	static const long REVISION  = 1055;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 304;
	#define RC_FILEVERSION 5,2,3,1055
	#define RC_FILEVERSION_STRING "5, 2, 3, 1055\0"
	static const char FULLVERSION_STRING [] = "5.2.3.1055";
