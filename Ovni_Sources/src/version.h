...
namespace AutoVersion{
	...
	static const long REVISION  = 8646;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 1553;
	#define RC_FILEVERSION 5,3,10,8646
	#define RC_FILEVERSION_STRING "5, 3, 10, 8646\0"
	static const char FULLVERSION_STRING [] = "5.3.10.8646";
