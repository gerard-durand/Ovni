...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 1572;
	#define RC_FILEVERSION 5,4,5,9385
	#define RC_FILEVERSION_STRING "5, 4, 5, 9385\0"
	static const char FULLVERSION_STRING [] = "5.4.5.9385";
