...
namespace AutoVersion{
	...
	static const long REVISION  = 4712;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 894;
	#define RC_FILEVERSION 5,3,1,4712
	#define RC_FILEVERSION_STRING "5, 3, 1, 4712\0"
	static const char FULLVERSION_STRING [] = "5.3.1.4712";
